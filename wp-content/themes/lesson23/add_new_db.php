<?php
/** Template Name: add_new_order_db
 *
 * Created by PhpStorm.
 * User: invis
 * Date: 02.04.2017
...
<div class="container">
    <div class="row">
        <h1>Результат добавления нового заказа</h1>
        <?php

        $link = mysqli_connect( "localhost", "root", "root", "kr" );
        $link->set_charset("utf8");
        $sql_add_new = "INSERT INTO orders VALUES ( NULL, ";
        ...
        if ($res) {
            ...
            echo "<p class='report_message alert-danger'>Ошибка записи в БД!:".$link->error."</p>".$sql_add_new;//Maybe need fix
            // value use -
